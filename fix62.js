...
fs.writeFileSync('middleware.js', newMiddleware);
console.log('✅ Updated middleware.js');
console.log('🎉 Done! Now run:');
console.log('   git add middleware.js && git commit -m "fix: update middleware with better titles and og tags for all pages" && git push\n');
