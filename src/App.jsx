...
export default function UnionPathway() {
  ...
  const getPageFromUrl = () => {
    ...
    const validPages = ['home','quiz','careers','checklist','locals','calculator','resume','veterans','history','trade-history','history-ibew','history-ua','retirement','benefits','about','contact','jobboard','wages','organize'];
