// fix167.js — Collapsible Apprenticeship Tests + History trades in mobile drawer
//
// What this does:
//   1. Adds 2 new state hooks for collapsible drawer sections
//   2. Adds CSS for a chevron-toggle pattern matching the drawer aesthetic
//   3. Wraps the 8 trade-history sub-links under a "Trade Histories ▾" toggle (collapsed default)
//   4. Adds 9 trade-specific Apprenticeship Test sub-links under a "Apprenticeship Tests ▾" toggle (collapsed default)
//
// Apprentice section and Tools section stay flat (high-intent, frequently used).
// General Union History stays as a flat link (it's the parent overview).
// Right to Work stays as a flat link in Resources.
...
// Anchor on existing mobileNavOpen declaration
// ============================================================
...
// Anchor on the existing .mobile-drawer-link.active rule
// ============================================================
...
// ============================================================
// EDIT 4: Wrap the 8 trade-history sub-links under a Trade Histories toggle
// ============================================================
...
console.log('  - "Trade Histories ▾" (collapsed by default, contains 9 trade entries)');
console.log('  - "Apprenticeship Tests ▾" (collapsed by default, contains 10 trade entries)');
console.log('  - Apprentice section stays flat (high-intent links)');
...
console.log('');
console.log('Now run:');
console.log('  git add src/App.jsx && git commit -m "feat: collapsible sub-lists in mobile drawer (history + tests)" && git push');
console.log('');
